...
def combien1(journalistes)
   nombre = journalistes.length 
   puts "il ya #{nombre} journalistes dans cette array"
   
end
#_________________________________
def court(journalistes)
    court = journalistes.min_by(&:size)
    puts "le @ le plus court est #{court}"
    return court
end
#_________________________________
def combien(journalistes)
    caractere
    puts "[resultat de journalistes]"
end
#_______________________________
def ordre(journalistes)
    ordre = journalistes.sort # exposer dans l'odre aplphabetique
    puts "et dans l'ordre: #{ordre}"
return ordre  
end  
#_______________________________
def position(journalistes)
    position = journalistes.index("@epenser")
    puts "@epenser est le #{position}eme dans la liste"
    return position
end

def perform(journalistes)
    combien1(journalistes)
end
